...
struct Teacher : Person {
  Teacher(std::string const& nm, int age,std::string const& course) : Person(nm, age), course_(course)
  {
    std::cout << name() << std::endl;
  }
  virtual std::string occupation() const {return "eacher"; }
...
struct Professor : Teacher {
  Professor(std::string const& name, int age, std::string const& course, std::string const& thesis)
